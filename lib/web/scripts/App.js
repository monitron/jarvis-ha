...
const EventBrowserView = require('./events/EventBrowserView.js');
...
module.exports = class App extends Backbone.Model {
  ...
  displayEvents() {
    ...
    const view = new EventBrowserView({model: this.eventBrowser});
  ...
  visitControl(id) {
    this.router.navigate('capability/controlBrowser', {trigger: true});
