...
module.exports = class ControlBrowserCapability extends Capability {
  ...
  createControlContainerView(controlId, options = {}) {
    const model = window.app.controls.get(controlId);
    return new ControlContainerView(
      _.defaults(options, {model, membership: {}}));
  }
